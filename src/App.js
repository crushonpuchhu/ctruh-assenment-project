...
function App() {
  ...
  return (
    <div className="App">
      ...
      <div onMouseMove={(e) => {
      ...
      }} style={{ backgroundColor: `${bg}` }} id='abc1234'>

        <div style={{ left: `${mouse.x}px`, top: `${mouse.y}px`, height: `${desi != {} ? desi.h : null}px`, width: `${desi != {} ? desi.w : null}px`, backgroundColor: `${desi != {} ? desi.bg : null}` }} id={"cursor"}> </div>
        ...
        <div id='div12234'>
          ...
          <div className='input'>
            ...
            <button onClick={() => { cal() }} className='btn1234'>SET</button>
